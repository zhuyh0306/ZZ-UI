<template>
  <table @click="handleYearTableClick" class="zz-year-table">
    <tbody>
    <tr>
...
<script type="text/babel">
  ...
  import { isDate, range, nextDate, getDayCountOfYear } from '@yhui/zz-ui/src/utils/date-util';
  import { arrayFindIndex, coerceTruthyValueToArray } from '@yhui/zz-ui/src/utils/util';
