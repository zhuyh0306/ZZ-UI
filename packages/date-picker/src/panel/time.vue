<template>
  <transition name="zz-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="zz-time-panel zz-popper"
      :class="popperClass">
      <div class="zz-time-panel__content" :class="{ 'has-seconds': showSeconds }">
        <time-spinner
          ref="spinner"
          @change="handleChange"
...
<script type="text/babel">
  import { limitTimeRange, isDate, clearMilliseconds, timeWithinRange } from '@yhui/zz-ui/src/utils/date-util';
