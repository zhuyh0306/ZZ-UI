    ...
    <span
      ...
      <i
        ...
        <i
          ...
          :style="decimalStyle"
          class="zz-rate__decimal">
        </i>
      </i>
    </span>
    <span v-if="showText || showScore" class="zz-rate__text" :style="{ color: textColor }">{{ text }}</span>
  </div>
</template>
  ...
  export default {
    ...
    props: {
      ...
      iconClasses: {
        type: [Array, Object],
        default() {
          return ['zz-icon-star-on', 'zz-icon-star-on', 'zz-icon-star-on'];
        }
      },
      voidIconClass: {
        type: String,
        default: 'zz-icon-star-off'
      },
      disabledVoidIconClass: {
        type: String,
        default: 'zz-icon-star-on'
      },
      disabled: {
        type: Boolean,
        default: false
    ...
    methods: {
      ...
      setCurrentValue(value, event) {
        ...
        if (this.allowHalf) {
          ...
          if (hasClass(target, 'zz-rate__item')) {
            target = target.querySelector('.zz-rate__icon');
          }
          if (hasClass(target, 'zz-rate__decimal')) {
